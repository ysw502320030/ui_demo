...
#include "../../Spine_To_Attach_UI_CLONE/TestIfGitPRJWorks/SpineToAttachUI/encoder.h"
...
QT_MOC_LITERAL(1, 8, 12), // "signal_LTurn"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 12) // "signal_RTurn"

    },
    "encoder\0signal_LTurn\0\0signal_RTurn"
};
...
void encoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_LTurn(); break;
        case 1: _t->signal_RTurn(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&encoder::signal_LTurn)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (encoder::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&encoder::signal_RTurn)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void encoder::signal_LTurn()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void encoder::signal_RTurn()
{
